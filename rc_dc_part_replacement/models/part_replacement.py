...
class PartReplacement(models.Model):
    _name = 'rc_dc_part_replacement.part_replacement'
    _description = 'Part Replacement'
    _inherit = 'mail.thread'

    name = fields.Char(string="Description...",)
    user_id = fields.Many2one(comodel_name="res.users", string="Requested by")
    partner_id = fields.Many2one(comodel_name="res.partner", string="Requested by")
    ...
    line_ids = fields.One2many(comodel_name="rc_dc_part_replacement.part_replacement.line", inverse_name="replacement_id", string="Fault Description")
...
class PartReplacementLine(models.Model):
    _name = 'rc_dc_part_replacement.part_replacement.line'
    ...
    replacement_id = fields.Many2one(comodel_name="rc_dc_part_replacement.part_replacement", string="Replacement")
