...
class SaleOrder(models.Model):
    ...
    # @api.multi
    def get_customer_order_values(self, user_id):
        partner = self.env.user.partner_id
        sale_orders = self.env['sale.order'].search([('message_partner_ids', 'child_of', [partner.commercial_partner_id.id]),('state', 'in', ['sale','done'])])
        myLabels  =[]
        myData_dict = {}
        myData =[]
        res ={}
    ...
    # @api.multi
    def get_month_order_values(self, user_id):
        partner = self.env.user.partner_id
        month_list = ['January','February','March','April','May','June','July','August','September','October','November','December']
        sale_orders = self.env['sale.order'].search([('message_partner_ids', 'child_of', [partner.commercial_partner_id.id]),('state', 'in', ['sale'])],order='date_order asc')
        myLabels  =[]
        myData = []
        res ={}
        date_dict = {}
    ...
    # @api.multi
    def get_order_values_by_date(self,user_id,start_date,end_date):
        partner = self.env.user.partner_id
        month_list = ['January','February','March','April','May','June','July','August','September','October','November','December']
        sale_orders = self.env['sale.order'].search([('message_partner_ids', 'child_of', [partner.commercial_partner_id.id]),('state', 'in', ['sale','done']),('date_order','>=',start_date),('date_order','<=',end_date)],order='date_order asc')
        myLabels  =[]
        myData = []
        res ={}
        date_dict = {}
    ...
    # @api.multi
    def get_order_values_by_year(self,user_id,start_date,end_date):
        partner = self.env.user.partner_id
        sale_orders = self.env['sale.order'].search([('message_partner_ids', 'child_of', [partner.commercial_partner_id.id]),('state', 'in', ['sale','done']),('date_order','>=',start_date),('date_order','<=',end_date)],order='date_order asc')
        myLabels  =[]
        myData = []
